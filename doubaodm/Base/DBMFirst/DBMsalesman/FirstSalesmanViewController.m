...
@interface FirstSalesmanViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FirstSalesmanViewController
...
//    self.contentArr = @[@"[合同]请问一下怎么添加上架商品",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款"];
    ...
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"业务员圈" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
...
//    mutdic[@"token"] = @"B53DFD7werwer2234vE3BCF71717836CF";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BusinessViewController *lvc = [[BusinessViewController alloc]init];
    
    lvc.salesmanStr = [_dataArr[indexPath.row] objectForKey:@"businessid"];
