...
//    self.contentArr = @[@"[合同]请问一下怎么添加上架商品",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款",@"[合同]阅读并提交合同条款"];
    ...
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"商户圈" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
...
//    mutdic[@"token"] = @"B53DFD76913C40BEBE3BCF71717836CF";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [tableView deselectRowAtIndexPath:indexPath animated:YES];
        ...
        lvc.str = [_dataArr[indexPath.row] objectForKey:@"userid"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.codeNameLab.text = [_dataArr[indexPath.row] objectForKey:@"username"];
//    cell.codeNumLab.text = [_dataArr[indexPath.row] objectForKey:@"content"];
