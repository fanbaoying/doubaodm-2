...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        iconBtn.titleLabel.font = [UIFont systemFontOfSize:14.0];
...
-(void)settingtData
{
    ...
    //创建头像
    [self.iconBtn setTitle:@"商户张三" forState:UIControlStateNormal];
...
//    
    ...
    for (int i = 0; i < [familyGroup.replys count]; i++) {
        ...
        {
            replyLabel.text = familyGroup.replys[i];
        }
...
-(void)settingFrame
{
    self.iconBtn.frame = self.familyGroupFrame.iconF;
