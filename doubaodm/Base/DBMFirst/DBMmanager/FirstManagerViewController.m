//
//  FirstManagerViewController.m
//  doubaodm
//
//  Created by 范保莹 on 2017/2/22.
...
@interface FirstManagerViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FirstManagerViewController
...
- (void)viewDidLoad {
    ...
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"主管圈" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FirstSalesmanViewController *lvc = [[FirstSalesmanViewController alloc]init];
