...
@interface CommerDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CommerDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    self.titleArr = @[@"资料客户",@"潜在客户",@"意向客户"];
    
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"商户类型" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
