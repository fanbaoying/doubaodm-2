...
- (void)viewDidLoad {
    ...
    self.titleArr = @[@"设备预约商户",@"审核成功商户",@"设备安装商户"];
    
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"设备实施" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
