...
- (void)viewDidLoad {
    ...
    self.titleArr = @[@"一级维护商户",@"二级维护商户",@"三级维护商户"];
    
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"后期维护" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
