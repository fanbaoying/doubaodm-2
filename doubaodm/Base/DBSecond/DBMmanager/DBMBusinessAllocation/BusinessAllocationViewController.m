//
//  BusinessAllocationViewController.m
//  doubaodm
//
...
@interface BusinessAllocationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BusinessAllocationViewController
...
- (void)viewDidLoad {
    ...
    self.nav = [[Nav alloc]initWithLeftBtn:@"back" andWithTitleLab:@"商户分配" andWithRightBtn:nil andWithBgImg:nil andWithLab1Btn:nil andWithLab2Btn:nil];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [service1 searchMessage:nil andWithAction:nil andWithDic:mutdic andUrl:getBusinessList andSuccess:^(NSDictionary *dic) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cdvc.userIdStr = [_dataArr[indexPath.row] objectForKey:@"userid"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.titleLab.text = @"资料客户";
    cell.contentLab.text = [_dataArr[indexPath.row] objectForKey:@"username"];
